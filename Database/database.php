...
class Database
{
    ...
    {
        // Pastikan $id adalah nilai tunggal dan bukan array
        if (is_array($id)) {
            // Jika $id adalah array, kita perlu memastikan kita menggunakan ID yang tepat
            // Anda bisa menggunakan ID pertama atau memproses sesuai kebutuhan Anda
            $id = reset($id); // Ambil elemen pertama dari array jika $id adalah array
        }

        if (empty($id)) {
            // Jika $id kosong, ambil semua data
            ...
            // Jika $id ada, ambil data berdasarkan id dan isDeleted
            // Pastikan $id bukan array pada query
